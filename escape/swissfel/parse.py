...
def parse_run(runno,pgroup,instrument,json_dir='/sf/{instrument}/data/{pgroup}/res/scan_info/'):
    files = Path(json_dir.format(instrument=instrument, pgroup=pgroup)).glob(f'run{runno:04d}*')
