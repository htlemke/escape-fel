...
from . import plots_new as plots
from . import tools
from .testStream_new import createStream
...
class EventWorker:
                ...
                with ctx as s:
                    ...
                    while not self._stop_event.is_set():
                        ...
                        if self.event.getEventId() is not None:
                            if hasattr(self.event, "_msg") and self.event._msg:
                                self._last_event_keys = list(self.event._msg.keys())
    ...
    def stopEventLoop(self):  # noqa: N802
        ...
        if hasattr(self, "loopThread") and self.loopThread.is_alive():
