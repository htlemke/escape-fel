"""
datahub-based event source wrappers for escape.stream_new.
...
class DataHubEventSourceContext:
    ...
    transparently skipped by the :class:`~escape.stream_new.EventWorker`.
    """
...
class DataHubEventHandler:
    ...
    Replaces :class:`~escape.stream_new.EventHandler_SFEL` and
...
class DataHubLocalEventHandler:
    ...
    started by :class:`~escape.stream_new.TestStream`) using datahub's
    ...
    does **not** need to restart when new :class:`~escape.stream_new.Stream`
